...
app.user = function( userid, cb ) {
	...
	return {
		...
		// Subscriptions
		subscriptions: function( vars, cb ) {
			app.talk( 'feeds/api/users/'+ userid +'/subscriptions', vars, cb)
		},

		//Watch history
		watch_history: function( vars, cb ) {
			app.talk( 'feeds/api/users/'+ userid +'/watch_history', vars, cb)
		},
...
app.talk = function( path, fields, cb, oldJsonKey ) {
	...
	var options = {
		...
		headers: {
			...
			'X-GData-Key': 'key=AI39si6BpMX3gbgMLd5YmtuwS9ry5eF2F9XAe9LParJujSTyZqQKCQF6tFdQtu3FUxmuTP-9E0SFEzbUGBO3zDg3rTIElYbYgg'
			//'Authorization': 'Bearer ya29.AHES6ZQ8KOaBlChoUyxsg2DPkwQIzymSbIilPpujhh-Qofk'
		},
		method:		'GET'
	}

	if (fields.accessToken != undefined) {
		options.headers.Authorization = 'Bearer ' + fields.accessToken;
	}
