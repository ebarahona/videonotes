...
( function() {
	var imageDialog = function( editor, dialogType ) {
			...
			var onUpload = function(input) {
				
				if (input) {
	            	var reader = new FileReader();
	            
		            reader.onload = function (e) {
		            	var id = document.getElementsByClassName("ImagePreviewBox")[0].querySelector("img").id;
			...
			return {
				...
				onShow: function() {
					...
					// Dont show preview if no URL given. - commented out by Ashish
				...
				onOk: function() {
					...
					} else // Create a new image.
					{
		            	...
		            	var srcdata = document.getElementById(id).getAttribute('src');
		            	this.imageElement.setAttribute('style', 'width:400px');
		            	this.imageElement.setAttribute('src', srcdata);
				...
				contents: [
					...
					elements: [
					{
						...
						onChange: function() {
							var that = this;
							var inputfile = document.getElementById("cke_154_fileInput").contentWindow.document.getElementById("cke_154_fileInput_input").files[0];
							onUpload(inputfile);
						}
